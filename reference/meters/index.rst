...
.. figure:: img/format-area.png
	:align: center
	
	Слева: скин с одним meter, который кажется "свободно-плавающим". Справа: тот же скин, но с добавлением цветного фона. Здесь видно, что meter (оранжевый) в действительности находится внутри окна скина (зелёный) и "толкает" граници этого окна в правый нижний угол.
