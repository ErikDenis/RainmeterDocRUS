...
*Слева: скин с одним meter, который кажется "свободно-плавающим". Справа: тот же скин, но с добавлением цветного фона. Здесь видно, что meter (цвет1).
...
* **Позиция "Z".**. Meters рисуються по порядку.Те, которые написаны ниже, появляются поверх тех, которые выше. Например, фоновое `изображение <meter_image>`_, которое находится под всеми meters, должно быть написано самым первым в коде скина.
